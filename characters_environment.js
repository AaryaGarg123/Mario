...
function startGame() {
  game_status = "Start";
  document.getElementById("status").innerHTML = "Game is Loding";
}
...
function game(){
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press The start button to Start playing the game ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
